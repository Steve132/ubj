...
void ubjw_end_array(struct ubjw_context_t* dst);
...
void ubjw_end_object(struct ubjw_context_t* dst);

//void ubjw_write_buffer(struct ubjw_context_t* dst,UBJW_TYPE type,)compute a strided buffer
